                ...
                <form id="form_contato">
                    <div class="modal-content bd-example-modal-lg-12">
                        <div class="modal-body" >                                    
                            ...
                            <div class='row'>
                                <div class='col-md-12' align="center"> 
                                    <button type="button" class="btn btn-secondary" id="cmdIncluirResponsavel" name="cmdIncluirResponsavel">Incluir Responsavel</button>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-secondary" id="cmdEnviarContrato"  name="cmdEnviarContrato">Salvar</button>
                        </div>
                    </div>
                </div>
            </div>
