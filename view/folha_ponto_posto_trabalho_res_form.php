...
<script src="folha_ponto_posto_trabalho_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>
<style type="text/css">
    .starter-template {
        padding: 40px 15px;
        text-align: center;
    ...
    <form method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-4" align="center">
                ...
                <button type="button" class="btn btn-link" id="cmdIncluir"><img src="../img/incluir.png" width=40 height=40>Gerar </button>
            </div>
        </div>
    </form>
    <hr style='height:1px; border:none; color:#14074F; background-color:#14074F; margin-top: 0px; margin-bottom: 0px;'>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">  
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <label for="produtos_servicos_pk">Posto de Trabalho:&nbsp;</label>
                        <select id="leads_pk_cad" class="form-control form-control-sm" name="leads_pk_cad">
                        </select>
                    </div>
                </div>
                <div class='row'>
