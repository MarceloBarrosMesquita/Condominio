...
?>
<script src="apontamento_res_form.js?<?php echo time(); ?>" type="text/javascript" charset="utf-8"></script>

<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h2>Apontamento Ponto</h2>
        </div>
    </div>
    <form method="post">
        <div class="row">
            ...
            <div class='col-md-4'>
                <label for="dt_ponto">:&nbsp;</label>
                <input type="text" class="form-control form-control-sm" id="dt_ponto" required="true">
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
